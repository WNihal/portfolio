  ...
  const experiences = [
    {
      ...
      description: 'Developing and maintaining fraud detection systems and risk management solutions.',
      current: true,
    },
    {
      ...
      location: '5 months',
      description: 'Worked on payment processing systems and financial technology solutions.',
      current: false,
    },
    {
      ...
      location: '1 year',
      description: 'Started as a trainee and developed expertise in software consulting and development.',
      current: false,
    },
  ];
                ...
                <div className={`ml-12 md:ml-0 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:ml-1/2'}`}>
                  <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h4 className="text-lg font-semibold text-blue-600 mb-2">
                      {exp.company}
                      {exp.department && <span className="text-gray-600"> • {exp.department}</span>}
                    </h4>
