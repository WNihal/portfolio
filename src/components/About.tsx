        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              ...
              backend development and fraud risk management systems. Currently
              working at Informatrix IT Solution Pvt Ltd, I specialize in
              building robust, scalable solutions that address complex business
              challenges.
            </p>

            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              My journey in software development has been driven by a passion
              for creating impactful solutions and continuously learning new
              technologies. I thrive in collaborative environments and enjoy
              tackling challenging problems that require innovative thinking.
            </p>
